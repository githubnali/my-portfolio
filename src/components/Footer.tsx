      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-gray-800">
          <div>
            ...
            I create digital experiences that are functional, visually engaging, and focused on solving real problems through clean, accessible, and creative code.            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#skills" className="text-gray-400 hover:text-amber-500 transition-colors">Skills</a>
              </li>
              <li>
                <a href="#experience" className="text-gray-400 hover:text-amber-500 transition-colors">Experience</a>
              </li>
              <li>
                <a href="#projects" className="text-gray-400 hover:text-amber-500 transition-colors">Projects</a>
              </li>
              <li>
